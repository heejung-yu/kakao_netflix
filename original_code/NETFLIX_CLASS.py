...
class Netflix_content_crawling_class:
    ...
    def login(self, id="", pw=""):
        ...
        #넷플릭스 시청할 프로필 선택
        self.driver.find_element_by_xpath('//*[@id="appMountPoint"]/div/div/div[1]/div[1]/div[2]/div/div/ul/li[2]/div/a/div/div').click() #프로필 버튼
        self.driver.implicitly_wait(3)
        print("넷플릭스 접속 완료")
    ...
    def content_crawling(self, w, image_list):
        print(str(self.word_key)+"/25 번 째 단어 콘텐츠 크롤링 중...")
        ...
        for i in range(4):  
            ...
            title=""
            title=self.driver.find_element_by_xpath('//*[@id="title-card-0-'+str(i)+'"]/div[1]/a/div[1]/div').text  #제목
        ...
        print("\n"+str(self.word_key)+"/25 번 째 단어 콘텐츠 크롤링 완료")
    ...
    def save(self):
        ...
        content_df.to_csv("콘텐츠.csv", encoding='euc-kr', index=False)  #저장할 로컬 주소
        casting_df.to_csv("캐스팅.csv", encoding='euc-kr', index=False)
        genre_df.to_csv("장르.csv", encoding='euc-kr', index=False)
        feature_df.to_csv("시리즈 특징.csv", encoding='euc-kr', index=False)
    ...
    def run(self):
        ...
        for w in self.word_list:
            ...
            try :
                self.driver.find_element_by_xpath('//*[@id="appMountPoint"]/div/div/div[1]/div[1]/div[1]/div/div/div/div[1]/div/div/svg').click() #검색창 클릭
            except Exception as e:
                pass
